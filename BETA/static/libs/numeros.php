		...
		if (trim($xaux) != "")
			...
			switch ($xz)
				...
				case 2:
					...
					//$mon_eda = XMLcomprobante($xml,'Moneda');	// Armando agrego 02/05/12
					$mon_eda = $si;
					...
					if ($xcifra < 1 )
					{
						switch($mon_eda)
						{
							...
							break;
							case "EUR":
								$xcadena = "CERO EUROS $xdecimales/100 ";
							break;
						}
					}
					...
					if ($xcifra >= 1 && $xcifra < 2)
					{
						switch($mon_eda)
						{
							...
							break;
							case "EUR":
								$xcadena = "UN EURO $xdecimales/100 ";
							break;
						}
					}
